...
fun ApiServerSettingsScreen(onBackClicked: () -> Unit) {
  ...
  Scaffold(
    ...
    Column(
      ...
      // --- Support the developer (aifadian) ---
      Card(
        modifier =
          Modifier
            .fillMaxWidth()
            .clickable {
              context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(AIFADIAN_URL)))
            },
      ) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
          Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            Image(
              painter = painterResource(R.drawable.aifadian),
              contentDescription = null,
              modifier = Modifier.size(24.dp),
            )
            Text(stringResource(R.string.settings_support_developer_title), style = MaterialTheme.typography.titleMedium)
          }
          Text(
            stringResource(R.string.settings_support_developer_desc),
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
          Text(
            stringResource(R.string.settings_support_developer_open),
            style = MaterialTheme.typography.bodyMedium,
      ...
      Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
          ...
          Row(
            ...
            modifier =
              Modifier
                .fillMaxWidth()
                .clickable {
                  context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(GITHUB_PROJECT_URL)))
                }
            ...
            Text(stringResource(R.string.settings_github_project), style = MaterialTheme.typography.bodyMedium)
          }
          ...
          Row(
            ...
            Text(stringResource(R.string.settings_github_profile), style = MaterialTheme.typography.bodyMedium)
          }
        }
      }
    }
...
private const val AIFADIAN_URL = "https://www.ifdian.net/a/Venshell"
private const val GITHUB_PROJECT_URL = "https://github.com/NukumizuKazuhiko/ai-edge-gallery-for-api-use"
private const val GITHUB_PROFILE_URL = "https://github.com/NukumizuKazuhiko"
